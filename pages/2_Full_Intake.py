...
All questions are in past tense with stable question IDs.
"""
...
# Full intake narrative questions with stable IDs (as specified)
FULL_QUESTIONS = {
    "q6": {
        "label": "Case Summary",
...
with st.form("full_intake_form", clear_on_submit=False):
    ...
    # Section 2: Narrative Questions (organized by section)
    st.header("2. Case Narrative")
    st.markdown("*Please provide detailed responses to each question. Answer in past tense.*")
...
with st.sidebar:
    ...
    - Narrative fields capture the story
    - Use scroll to navigate all sections
    """)
